  ...
  "Statement": [
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::996542365363:root"
      },
      "Action": "kms:*",
      "Resource": "*"
    },
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::996542365363:user/admin-username"
      },
      "Action": [
        "kms:Create*",
        "kms:Describe*",
    ...
    },
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::996542365363:user/user1@example.com"
      },
      "Action": [
        "kms:Encrypt",
        "kms:Decrypt",
    ...
    },
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::996542365363:user/user2@example.com"
      },
      "Action": [
        "kms:CreateGrant",
        "kms:ListGrants",
